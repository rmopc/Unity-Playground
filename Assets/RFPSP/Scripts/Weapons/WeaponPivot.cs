...
public class WeaponPivot : MonoBehaviour {
	...
	void Start () {
		...
		PivotAnimComponent["WeaponPivotVert"].layer = 1;
		PivotAnimComponent["WeaponPivotJump"].layer = 2;
		PivotAnimComponent["WeaponPivotLand"].layer = 2;
	...
	public void PlayAnim() {
		if (FPSPlayerComponent.bulletTimeActive && FPSWalkerComponent.sprintActive) {
			return;
		}
		PivotAnimComponent.Rewind("WeaponPivotVert");
		if(deadzoneZooming && deadzoneLooking){
			PivotAnimComponent["WeaponPivotVert"].speed = 0.6f;
		}else{ 
			PivotAnimComponent["WeaponPivotVert"].speed = WeaponBehaviorComponent.pivotBobSpeed * Mathf.Max(InputComponent.moveX, InputComponent.moveY);
		}
	...
	public void PlayJumpAnim() {
		...
		PivotAnimComponent.Rewind("WeaponPivotJump");
		PivotAnimComponent["WeaponPivotJump"].speed = animSpeed;
		PivotAnimComponent.CrossFade("WeaponPivotJump", 0.1f,PlayMode.StopSameLayer);//play weapon swing animation
	}
	...
	public void PlayLandAnim() {
		...
		PivotAnimComponent.Rewind("WeaponPivotLand");
		PivotAnimComponent["WeaponPivotLand"].speed = animSpeed;
		PivotAnimComponent.CrossFade("WeaponPivotLand", 0.1f,PlayMode.StopSameLayer);//play weapon swing animation
	}
